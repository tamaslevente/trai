...
#include <string>
#include <shape_finder/gravity_nodeConfig.h>
...
public:
    ...
    void
    dynReconfCallback(shape_finder::gravity_nodeConfig &config, uint32_t level)
    {
    ...
    imuCallback(const sensor_msgs::Imu::ConstPtr &msg)
    {
        ...
        gravity_marker2.color.r = 1.0f;
        gravity_marker2.color.g = 0.0f;
        gravity_marker2.color.b = 0.0f;
...
private:
    ...
    ros::Publisher g_pub;
    dynamic_reconfigure::Server<shape_finder::gravity_nodeConfig> config_server_;
    Eigen::Vector3f gravity, gravity0, gravityk;
    int gravity_damp = 5;
...
{
    ros::init(argc, argv, "gravity_nodelet");
    GravityNode gn;
    ros::spin();
}