...
def draw_registration_result(source, target, transformation):
    ...
    o3d.io.write_point_cloud("res1.pcd", source_temp + target_temp)
    ...
    for id1 in range(num_frag):
        for id2 in range(id1 + 1, num_frag):
            ...
            if key not in gtLog.keys():
                ...
                if id1 == 1 and scene == '7-scenes-redkitchen':
                    ...
                    draw_registration_result(pcd_s, pcd_t, result_ransac.transformation)

                    o3d.io.write_point_cloud("res.pcd",pcd_s + pcd_s_corr + pcd_t + pcd_t_corr)
    ...
    for scene in dset.scene_list:
        ...
        for ids in range(num_frag):
            ...
            if ids is 10000:
                ...
                # o3d.visualization.draw_geometries([vis_pcd])
                custom_draw_geometry_with_custom_fov(pcd, 50.0)
