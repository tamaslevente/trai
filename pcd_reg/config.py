...
opt_arg.add_argument('--max_epoch', type=int, default=30)
...
data_arg.add_argument('--root', type=str, default='/home/benji/projects/D3Feat/data/3DMatch/')
...
data_arg.add_argument('--augment_noise', type=float, default=0.05)
