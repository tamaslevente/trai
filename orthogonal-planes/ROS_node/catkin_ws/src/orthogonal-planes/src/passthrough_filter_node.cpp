...
#include <ppfplane/passthrough_filter_nodeConfig.h>
...
public:
  ...
  void
  dynReconfCallback(ppfplane::passthrough_filter_nodeConfig &config, uint32_t level)
  {
...
private:
  ...
  dynamic_reconfigure::Server<ppfplane::passthrough_filter_nodeConfig> config_server_;
