...
#include <ppfplane/plane_segmentation_nodeConfig.h>
...
public:
  ...
  void
  dynReconfCallback(ppfplane::plane_segmentation_nodeConfig &config, uint32_t level)
  {
...
private:
  ...
  dynamic_reconfigure::Server<ppfplane::plane_segmentation_nodeConfig> config_server_;
