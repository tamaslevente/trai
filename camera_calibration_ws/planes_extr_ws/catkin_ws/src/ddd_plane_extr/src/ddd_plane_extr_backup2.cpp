...
public:
   ...
   */
    ...
    void cloudCallback(const PointCloud::ConstPtr &cloud_in_msg)
    {
        ...
        // Extract inliers
        extract1.setInputCloud(cloud_filtered1);
        ...
        // normal << okCoefficients->values[0], okCoefficients->values[1], okCoefficients->values[2];
        // int normSign = 1;
        // for (int i = 0; i < cloud_plane->points.size(); i++)
        // {
        //     Eigen::Vector3f point;
        //     point << cloud_plane->points[i].x, cloud_plane->points[i].y, cloud_plane->points[i].z;
        //     if (okCoefficients->values[3] < 0)
        //     {
        //         normSign = -1;
        //     }
        //     cloud_plane->points[i].y = -1;
        //     distance = normal * point + okCoefficients->values[3];
        //     distance = normSign * okCoefficients->values[0] * cloud_plane->points[i].x + normSign * okCoefficients->values[1] * cloud_plane->points[i].y + normSign * okCoefficients->values[2] * cloud_plane->points[i].z + okCoefficients->values[3];
        //     cloud_plane->points[i].y = cloud_plane->points[i].y + distance;
        // }
        ...
        gt_cloud->points = cloud_projected->points;
