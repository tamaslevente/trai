...
def start_node():
    ...
    rospy.init_node('distort_sync_timestamps')
    rospy.loginfo('distort_sync_timestamps started')
    ...
    image_sub = message_filters.Subscriber("/aditof_roscpp/aditof_depth", Image)
    ...
    image_pub = rospy.Publisher('/distort_aditof_image_depth_sync', Image, queue_size=1)
    info_pub = rospy.Publisher('/distort_aditof_camera_info_sync', CameraInfo, queue_size=1)
    rospy.spin()
