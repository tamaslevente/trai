...
def parse_args():
    ...
    parser.add_argument('--input_image_path', dest='input_image_path',
                    ...
                    #   default='/media/rambo/ssd2/marian/datasets/monodepth/training_data/depth_synth/', type=str)
                      default='/home/marian/calibration_ws/monodepth-FPN/MonoDepth-FPN-PyTorch/dataset/training_data/training_data/curvature_grad/prediction/', type=str)
    parser.add_argument('--eval_folder', dest='eval_folder',
                      help='evaluate only one image or the whole folder',
                      default=True, type=bool)
    parser.add_argument('--model_path', dest='model_path',
                      help='path to the model to use',
                    #   default='/home/marian/calibration_ws/monodepth-FPN/good_models/i2d_1_24.pth', type=str)
    ...
    if args.eval_folder:
        ...
        for filename in dlist:
            if filename.endswith(".png"):
                ...
                #  just for a faire compare
                plt.imshow(orig_depth, vmin=0, vmax=max_depth)
                plt.colorbar()
                ...
                o3d_pcd.points = o3d.utility.Vector3dVector(z_orig_pcd*max_depth)
