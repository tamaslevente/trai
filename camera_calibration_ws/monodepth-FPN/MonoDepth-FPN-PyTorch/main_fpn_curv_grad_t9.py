...
from model_fpn_curv_grad_t9 import I2D
import argparse
import time
...
class DDDDepthDiff(nn.Module):
    ...
    def forward(self, fake, real,epoch,show_image):
        if not fake.shape == real.shape:
            _, _, H, W = real.shape
            fake = F.interpolate(fake, size=(H, W), mode='nearest')
        eps = 1e-7
        # eps = 2
...
def parse_args():
    ...
    parser.add_argument('--output_dir', dest='output_dir',
                        ...
                        default='saved_models_t9', type=str)
...
if __name__ == '__main__':
    ...
    for epoch in range(args.start_epoch, args.max_epochs):
        ...
        save_dir = '/home/marian/workspace/monodepth_ws/monodepth-FPN/MonoDepth-FPN-PyTorch/dataset/training_data/training_data/training_process_t9/'
        ...
        with torch.no_grad():
            ...
            file_object = open("/home/marian/workspace/monodepth_ws/monodepth-FPN/MonoDepth-FPN-PyTorch/results_t9.txt", 'a')
