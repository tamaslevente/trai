...
class DDDDepthDiff(nn.Module):
    ...
    def forward(self, fake, real,epoch,show_image):
        ...
        loss_curv = (loss17 + 1/loss17)*plane_mean_dist_grad
...
if __name__ == '__main__':
    ...
    for epoch in range(args.start_epoch, args.max_epochs):
        ...
        save_dir = '/home/marian/workspace/monodepth_ws/monodepth-FPN/MonoDepth-FPN-PyTorch/dataset/training_data/training_data/training_process_t4/'
        ...
        with torch.no_grad():
            ...
            file_object = open("/home/marian/workspace/monodepth_ws/monodepth-FPN/MonoDepth-FPN-PyTorch/results_t4.txt", 'a')
