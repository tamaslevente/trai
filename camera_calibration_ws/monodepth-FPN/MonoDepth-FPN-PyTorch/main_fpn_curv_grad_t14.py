...
def parse_args():
    ...
    parser.add_argument('--output_dir', dest='output_dir',
                        ...
                        default='saved_models_t14', type=str)
...
if __name__ == '__main__':
    ...
    for epoch in range(args.start_epoch, args.max_epochs):
        ...
        save_dir = '/home/marian/workspace/monodepth_ws/monodepth-FPN/MonoDepth-FPN-PyTorch/dataset/training_data/training_data/training_process_t14/'
        ...
        with torch.no_grad():
            ...
            file_object = open("/home/marian/workspace/monodepth_ws/monodepth-FPN/MonoDepth-FPN-PyTorch/results_t14.txt", 'a')
