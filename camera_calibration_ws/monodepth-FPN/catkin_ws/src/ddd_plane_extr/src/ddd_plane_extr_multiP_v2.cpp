...
public:
   ...
   */
    Planes2Depth() : it_(nh_)
    {
        ...
        string saveDirPcd = "/home/marian/calibration_ws/monodepth-FPN/MonoDepth-FPN-PyTorch/dataset/training_data/multiP_training_data/multiP6/pcd_gt/"; // BEWARE of that last / !!! You don't want to forget that, trust me!
        ...
        string saveDirDepth = "/home/marian/calibration_ws/monodepth-FPN/MonoDepth-FPN-PyTorch/dataset/training_data/multiP_training_data/multiP6/depth_gt_filled/"; // BEWARE of that last / !!! You don't want to forget that, trust me!
    ...
    {
        string only_points_path = "my_full_custom_pcdmultiP6.pcd";
        ...
        if (pcl::io::loadPCDFile<pcl::PointXYZ>(only_points_path, *only_points) == -1) //* load the file
        {
        ...
        while (cloud1->size() > _remained_pointcloud * nr_points)
        {
            ...
            hull.setAlpha(_alpha);                                                                // pretty sensible
