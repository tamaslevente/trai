...
class _ShapeNetDataset(Dataset):
    def __init__(self, root, num_points, split='train', with_normal=True, with_one_hot_shape_id=True,
        ...
        with open(os.path.join('/home/rambo/pvcnn/', self.root, 'synsetoffset2category.txt'), 'r') as f:
        ...
        if self.split == 'train':
            ...
            split = ['test']
        for s in split:
            with open(os.path.join('/home/rambo/pvcnn/', self.root, 'train_test_split', f'shuffled_{s}_file_list.json'), 'r') as f:
    ...
    def __getitem__(self, index):
        if index in self.cache:
            ...
            # read the x, y, z coordinates from the classes (Cylinder, Sphere, HPlane, VPlane)
