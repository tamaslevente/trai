...
if __name__ == '__main__':
    ...
    parser.add_argument('--lmdb_test', default='/home/cuda/Alex/trai/PC-NBV/data/Rosbag_data/test.lmdb')
    parser.add_argument('--model_type', default='pc-nbv')
    parser.add_argument('--checkpoint', default='/home/cuda/Alex/trai/PC-NBV/Archive/Archive_model/Rosbag_model/model-400000')
