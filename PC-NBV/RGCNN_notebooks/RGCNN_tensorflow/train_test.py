...
def genData(cls,limit=None):
    ...
    pos = np.load("/home/alex/Alex_documents/RGCNN/seg_%s_pos.npy" % cls)
    norm = np.load("/home/alex/Alex_documents/RGCNN/seg_%s_norm.npy" % cls)
    label = np.load("/home/alex/Alex_documents/RGCNN/seg_%s_seg.npy" % cls)
