...
int main(int argc, char **argv)
{
  ...
  std::string path="/home/alex-pop/Desktop/Doctorat/Side_projects/orthogonal-planes/data/pcd_conversions/";
  ...
  else
  {
    ...
    std::string save_string=path+filename;
    
    pcl::io::savePCDFileASCII(save_string + "_norm.pcd", cloudnormals);
