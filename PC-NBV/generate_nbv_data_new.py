...
if __name__ == '__main__':
    ...
    model_dir = '/home/cuda/Alex/trai/PC-NBV/Shapenet_v1/Dataset_new/' + data_type
    ...
    for class_id in class_list:
        ...
        for model in model_list:
            ...
            #for ex_index in range(16):  
                ...
                if (("Top_050") in class_id):
                    print("Position is Top_050")
                    view_state[0]=1

                if (("Top_100") in class_id):
                    print("Position is Top_100")
                    view_state[1]=1
                if (("Sameheight_050") in class_id):
                    print("Position is Sameheight_50")
                    view_state[2]=1
                if (("Sameheight_100") in class_id):
                    print("Position is Sameheight_100")
                    view_state[3]=1
                ...
                for scan_index in range(1):    
                    ...
                    for i in range(view_num): 
                         ...
                         if ((('Asus_Box1') in class_id) | (('Asus_box1') in class_id))  :
