...
class Model:
    ...
    def create_encoder(self, inputs, npts, view_state):
        with tf.variable_scope('encoder_0', reuse=tf.AUTO_REUSE):
            ...
            features = tf.reshape(features, (1, tf.shape(features)[1], 1, 528)) #512+16+size(viewstate)   #(571 initial) (544 pentru 16) #(533 pentru 5) #(532 pentru 4)
